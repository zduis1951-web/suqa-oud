...
const Header = ({ variant = 'solid' }: HeaderProps) => {
  ...
  return (
    <>
      ...
      {/* Main Header */}
      <header 
        className={`header-container ${isTransparent ? 'header-transparent' : 'header-solid'} ${isScrolled ? 'header-scrolled' : ''}`}
      >
        <div className="header-content">
          ...
          <div className="header-top-row">
            ...
            <div className="header-left">
              <button
                className="country-selector-premium group"
            ...
            <div className="header-right">
              {/* Search */}
              <button
                className="header-icon-premium group"
              ...
              {/* Cart */}
              <button
                className="header-icon-premium cart-icon group"
              ...
              {/* Mobile Menu Toggle */}
              <button
                className="header-icon-premium lg:hidden"
          ...
          <nav 
            className="nav-row hidden lg:flex"
