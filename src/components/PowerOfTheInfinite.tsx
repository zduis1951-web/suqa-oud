...
const PowerOfTheInfinite = ({
  ...
  return <section className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-end pb-32 md:pb-44 lg:pb-56">
        ...
        {/* Explore Button */}
        <button onClick={onShopNowClick} className="px-8 md:px-10 py-3 md:py-3.5 bg-white text-black text-xs md:text-sm tracking-[0.2em] font-light border border-transparent hover:bg-transparent hover:text-white hover:border-white transition-all duration-300" aria-label="Explore The Craft">
          EXPLORE
        </button>
      </div>
