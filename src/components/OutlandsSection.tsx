...
const OutlandsSection = ({
  ...
  return <section className="outlands-section" aria-label="Our Philosophy - SUQA OUD">
      {/* Background Video */}
      <video ref={videoRef} className="absolute inset-0 h-full w-full object-cover" src={outlandsVideo} autoPlay muted loop playsInline aria-hidden="true" />
      ...
      <div className="outlands-content">
        {/* Title */}
        <h2 className="outlands-title text-white text-center text-sm">COMPLIMENTARY WRAPPING AND PERSONALIZATION CHOICES. A GIFT FIT FOR KINGS.
      </h2>
