...
const Footer = () => {
  ...
  return <footer className="w-full bg-black text-white">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-1">
            ...
            <form onSubmit={handleSubmit} className="mb-4">
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="E-mail" required className="w-full bg-transparent border border-white/40 px-4 py-3 text-sm text-white placeholder:text-white/50 focus:outline-none focus:border-white mb-3" />
              <button type="submit" className="w-full bg-white text-black text-xs tracking-[0.2em] uppercase py-3 px-6 hover:bg-white/90 transition-colors font-medium">
                Subscribe
              </button>
            </form>
