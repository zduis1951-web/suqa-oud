        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              High Perfumery from the Sultanate of Oman, founded in 1983.
            </p>
          ...
          <div className="lg:col-span-1">
            ...
            <form onSubmit={handleSubmit} className="mb-4">
              <input
                ...
                placeholder="E-mail"
                required
                className="w-full bg-transparent border border-white/40 px-4 py-3 text-sm text-white placeholder:text-white/50 focus:outline-none focus:border-white mb-3"
              />
              <button
                type="submit"
                className="w-full bg-white text-black text-xs tracking-[0.2em] uppercase py-3 px-6 hover:bg-white/90 transition-colors font-medium"
              >
                Subscribe
              </button>
            </form>
